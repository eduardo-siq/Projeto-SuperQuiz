...
public class EzSS_AppleManager{
	...
	public IphoneXColors iphoneXColor = EzSS_AppleManager.IphoneXColors.black;
	...
	public string SmartphoneColorSelector(){
		...
		else if (smartphonesApple == Smartphones.iphone7)
		{
		...
		{
			iphoneXColor = (IphoneXColors)EditorGUILayout.EnumPopup("Color:", iphoneXColor);
			return iphoneXColor.ToString();
		}
	}
	#endregion =========================================================================================================
	...
	public Dictionary<string, Vector2> devicesFixedSizes = new Dictionary<string, Vector2>(){
		...
		{"iphoneX", new Vector2(920f, 1820f)},
	...
	public Dictionary<string, EzSS_AspectHelper.Aspects> devicesAspects = new Dictionary<string, EzSS_AspectHelper.Aspects>(){
		...
		{"iphoneX", EzSS_AspectHelper.Aspects.aspect_9_19},
	...
	public Dictionary<string, Vector2> devicesScreenPercentage = new Dictionary<string, Vector2>(){
		{"iphone5c", new Vector2(83.945f, 71.825f)},
		{"iphone5s", new Vector2(84.983f, 71.918f)},
		{"iphone6s", new Vector2(82.531f, 74.457f)},
		{"iphone7", new Vector2(83.255f, 74.791f)},
		{"iphoneX", new Vector2(85.13f, 95.256f)},
		{"ipadAir2", new Vector2(83.48f, 79.37f)},
		{"imac", new Vector2(92.9f, 62.31f)},
		{"macbook", new Vector2(76.3f, 80.69f)},
		{"macbookAir", new Vector2(74.25f, 78.41f)},
		{"macbookPro", new Vector2(76.1f, 80.52f)},
		{"watchSeries1", new Vector2(61.54f, 40.19f)}
	};
