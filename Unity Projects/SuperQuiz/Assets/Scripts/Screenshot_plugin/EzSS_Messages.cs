public class EzSS_Messages    {
	...
	// Erros
	public const string ERROR_00 = "There's no camera selected. Please, select at least one camera and try again.";
	public const string ERROR_01 = "Please, choose a destination to save the image and try again.";

	// Warnings
	public const string WARNING_00 = "Select the camera to continue.";
	...
	// Info
	public const string INFO_00 = "Using background the final size to your image will be the values defined on the background size inside Resolutions.";
